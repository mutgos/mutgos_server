...
#ifndef MUTGOS_DBTYPE_ROOM_H_
#define MUTGOS_DBTYPE_ROOM_H_
...
{
    /**
     * Represents a tradiional MUD room that can contain Entities such as
     * Things, Players, etc.  This is what Players interact inside.
     */
    class Room : public ContainerPropertyEntity
    {
    public:
        /**

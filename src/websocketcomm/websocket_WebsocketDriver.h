/*
 * websocket_WebsocketDriver.h
 */

#ifndef MUTGOS_WEBSOCKET_WEBSOCKETDRIVER_H
#define MUTGOS_WEBSOCKET_WEBSOCKETDRIVER_H
...
namespace websocket
{
    ...
    /**
     * Driver class for websockets.
     *
     * This is not thread safe.
     */
    class WebsocketDriver : public comm::ConnectionDriver
    {
    public:
        /**
         ...
         */
        WebsocketDriver(comm::RouterSessionManager *router);

        /**
         * Required virtual destructor.
         */
        virtual ~WebsocketDriver();
         ...
         */
        void add_reference(WSClientConnection *connection_ptr);
         ...
         * called back later.
         */
        void connection_has_pending_actions(WSClientConnection *connection_ptr);

    private:
        typedef std::vector<WSClientConnection *> PendingActions;
        typedef std::vector<WSClientConnection *> PendingDeletes;
        /** First is the pointer to the connection, second is number of references */
        typedef std::map<WSClientConnection *, MG_SignedInt> ClientConnections;
...
#endif //MUTGOS_WEBSOCKET_WEBSOCKETDRIVER_H

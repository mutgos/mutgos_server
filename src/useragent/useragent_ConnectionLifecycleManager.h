/*
 * useragent_ConnectionLifecycleManager.h
 */

#ifndef MUTGOS_USERAGENT_CONNECTIONLIFECYCLEMANAGER_H
#define MUTGOS_USERAGENT_CONNECTIONLIFECYCLEMANAGER_H
...
namespace useragent
{
     ...
     * for connects or disconnects across all sites until the server is
     * shutdown.  If a connection is made, it will spawn off the user agent for
     * that connection.  If a disconnection is performed, it will tell the
     * executor to kill all processes for that Player.
     *
     * In short, when you connect, this is what starts the agent.
     */
    class ConnectionLifecycleManager : public executor::Process
    {
    public:
        /**
         * Constructor.
         */
        ConnectionLifecycleManager(void);

        /**
         * Required virtual destructor.
         */
        virtual ~ConnectionLifecycleManager();
    ...
    private:
        ...
        /**
         * Handles a connection (includes connects and disconnects) evnet.
...
#endif //MUTGOS_USERAGENT_CONNECTIONLIFECYCLEMANAGER_H
